# heltecwifilora32v4/config.py

from machine import ADC, Pin, PWM
from micropython import const

"""
    Configuration for Heltec WiFi LoRa 32 V4
    ...
    LoRa:
        ...
        PA_POWER = 7        (ADC input)
        PA_EN    = 2        (set high)
        PA_TX_EN = 46       (set high)
...
LORA_PA_POWER_PIN = ADC(Pin(7))
LORA_PA_EN_PIN = Pin(2, Pin.OUT)
LORA_PA_TX_EN_PIN = Pin(46, Pin.OUT)
...
# GPS pin assignments for L76K (UART)
UART_BUS_ID = const(2)
GPS_GPIO_CTRL = Pin(34, Pin.OUT)
GPS_GPIO_RST = Pin(42, Pin.OUT)
GPS_TX_PIN = Pin(38)
GPS_RX_PIN = Pin(39)
